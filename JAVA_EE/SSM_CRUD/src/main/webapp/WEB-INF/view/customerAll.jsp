...
%>
        ...
        <div class="row">
        <div class="col-lg-12">
        <h1 class="page-header">云知乎用户管理</h1>
        </div>
        </div>
        </div>
        ...
        data-target="#newCustomerDialog" onclick="clearCustomer()">新建用户信息</span>
        </button>
        <%--===================================--%>

        <form class="form-inline" method="get" action="${pageContext.request.contextPath}/customer.action">
        ...
        <input type="text" placeholder="联系方式" id="new_phone" name="phone"
        class="form-control"/>
        </div>
        </form>
        </div>
